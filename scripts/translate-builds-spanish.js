...
const buildsSpanish = [
  {
    ...
    build_steps: [
      ...
      { time: "~10:00", action: "Timing de victoria" }
    ]
  },
  {
    ...
    build_steps: [
      ...
      { action: "Encolar 2 Marines en primer Barracks" },
      ...
      { action: "Nunca empujar de a poco - reunir Army primero" },
...
async function translateBuildsSpanish() {
  try {
    console.log("🇪🇸 Traduciendo builds a español...\n");

    for (const build of buildsSpanish) {
      ...
      console.log(`   Descripción actualizada a español`);
      console.log(`   ${build.build_steps.length} pasos traducidos`);
      console.log('');
    }

    console.log("✨ Builds traducidos a español completamente\n");
